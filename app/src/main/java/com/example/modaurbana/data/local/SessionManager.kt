 ...
 * - Expone Flows reactivos para observar cambios
...
class SessionManager(private val context: Context) {
    ...
    // --- FLOW: Avatar reactivo ---
    /**
     * Flujo que emite la URI del avatar en tiempo real.
     * Retorna "" si no hay imagen guardada.
     */
    val avatarUriFlow = context.dataStore.data.map { prefs ->
